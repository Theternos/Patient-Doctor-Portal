    ...
    <div class="container">
        ...
        if ($_POST) {
            ...
            if (isset($_POST["search"])) {
                ...
                $sqlmain = "SELECT * from patient where pemail='$keyword' or pname='$keyword' or pname like '$keyword%' or pname like '%$keyword' or pname like '%$keyword%' or pemail like '$keyword%' or pemail like '%$keyword' or pemail like '%$keyword%' ORDER BY pname ASC";
                $selecttype = "";
            }
        } else {
            $sqlmain = "SELECT * from patient ORDER BY pname ASC";
            $selecttype = "My";
        }
